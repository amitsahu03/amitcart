...
const Contact = () => {
    ...
    const sendMessage = async () => {
        ...
        try {
            showLoader();
            const res = await sendMessageToBacked(name, email, message);
            hideLoader();
            if(res.status){
    ...
    const sendMessageToBacked = async () => {
                    ...
                    <div className="contact_us_left_section">
                        ...
                        <Flex align='center' gap={'xs'} justify={'flex-start'} className='contact-email'>
                            ...
                            <Text fz={isMobile ? 'sm' : 'md'} fw={'normal'} display={'inline-block'} style={{'flexGrow':0}}>
                                <a href="mailto:amitsahuald03@gmail.com">amitsahuald03@gmail.com</a>
                            </Text>
                        </Flex>
                        <Flex align='center' gap={'xs'} justify={'flex-start'} className='contact-social'>
                            <a href="https://github.com/amitsahu03" target="_blank" rel='noreferrer'>
                                <BsGithub size={30}/>
                            </a>
                        </Flex>
                    </div>
